...
<body>
  ...
  <main>
    <div class="position-relative">
      <!-- shape Hero -->
      <section class="section section-lg section-shaped pb-250" style="background-image: url(<?= BASEURL; ?>/img/bg_index.jpg); background-size: cover;">
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="btn-wrapper">
                  <a href="<?= BASEURL; ?>/auth/login" class="btn btn-white btn-icon mb-3 mb-sm-0">
                    <span class="btn-inner--text">LOGIN</span>
                  </a>
                  <a href="<?= BASEURL; ?>/auth/registrasi" class="btn btn-dark btn-icon mb-3 mb-sm-0">
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <a href="<?= BASEURL; ?>/auth/registrasi" class="btn btn-warning mt-4">Learn more</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <a href="<?= BASEURL; ?>/auth/login" class="btn btn-danger mt-4">Learn more</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="<?= BASEURL; ?>/assets/img/theme/promo-1.png" class="img-fluid floating">
          </div>
        ...
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-lg-2 ml-lg-auto">
            <div class="position-relative pl-md-5">
              <img src="<?= BASEURL; ?>/assets/img/ill/ill-2.svg" class="img-center img-fluid">
            </div>
          </div>
  ...
  <script src="<?= BASEURL; ?>/assets/vendor/headroom/headroom.min.js"></script>
  <!-- Argon JS -->
  <script src="<?= BASEURL; ?>/assets/js/argon.js?v=1.0.1"></script>
</body>
